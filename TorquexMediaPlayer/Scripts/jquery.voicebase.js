...
var voiceBase = (function($) {
    ...
    VB.default_settings = {
        ...
        localData: !1,
        localSearch: !1,
        localSearchHelperUrl: '/Scripts/workers/',
    ...
    VB.events = {
        ...
        onTime: function() {
            if(VB.instances[VB.current_instance].player && VB.instances[VB.current_instance].player.interface){
                ...
                if (VB.PlayerApi.getStatus() == "PLAYING")
                {
                    ...
                    if (theVideo.playbackRate == 1.0)
                    {
                        document.getElementById("vbs-playback-title-id").textContent = "";
                    } else {
                    ...
                    var playbackelement = document.getElementById("vbs-playback-title-id");
                    playbackelement.textContent = "";
        ...
        registerEvents: function() {
            ...
            function playbackfunc() {
                    ...
                    var theVideo = document.querySelector('video');
                    theVideo.playbackRate = playbackspeed;
                    playbackclass = document.getElementById('vbs-playback-title-id');
                    playbackclass.style.display = 'hi';
                }
...
//            VB.data.movelistner = false;
            ...
            // Dowload transcript
            VB.helper.find('.vbs-download-popup').on(eventsTypes, '.vbs-donwload-pdf, .vbs-donwload-rtf, .vbs-donwload-srt, .vbs-donwload-docd', function(event) {
                event.preventDefault();
        ...
        view: {
            ...
            checkExpandKeywordBlock: function () {
                ...
                if(!VB.settings.expandKeywordsBlock) {
                    ...
                    $keywords_block.find(".vbs-section-title").addClass('vbs-hidden');
